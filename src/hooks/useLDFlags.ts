...
export interface FlagSet {
  ...
  /** Experiment Hunter: desktop homepage persistent product-card quick add. */
  'eh-desktop-visible-card-quick-add-desktop': boolean
...
const defaults: FlagSet = {
  ...
  'eh-desktop-visible-card-quick-add-desktop': false,
...
export function useLDFlags(): FlagSet {
  ...
  return {
    ...
    'eh-desktop-visible-card-quick-add-desktop':
      flags['eh-desktop-visible-card-quick-add-desktop'] ??
      defaults['eh-desktop-visible-card-quick-add-desktop'],
