...
export interface FlagSet {
  ...
  /** Legacy visible-ATC flag kept for existing tests / rollouts. */
  'show-product-card-add-to-cart': boolean
  /** Experiment Hunter: desktop homepage product-card CTA visibility. */
  'eh-desktop-visible-card-cta-desktop': boolean
...
const defaults: FlagSet = {
  ...
  'eh-desktop-visible-card-cta-desktop': false,
...
export function useLDFlags(): FlagSet {
  ...
  return {
    ...
    'eh-desktop-visible-card-cta-desktop': playwrightAtcTreatment
      ? true
      : (flags['eh-desktop-visible-card-cta-desktop'] ?? defaults['eh-desktop-visible-card-cta-desktop']),
